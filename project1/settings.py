...
SECRET_KEY = 'django-insecure-iwz2dcp_b0d7hetjo&s%^8r_ynppso19t(jxo6r9q4pdnmt!i7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['web-production-49c9.up.railway.app', '127.0.0.1', 'localhost']
CSRF_TRUSTED_ORIGINS = ['https://project1']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'ZPmHVQzKBqt4bKYDwOVQ',
        'HOST': 'containers-us-west-33.railway.app',
        'PORT': '7916',
    }
} # Railway.app name bored-war
